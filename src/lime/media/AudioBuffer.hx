...
class AudioBuffer
{
	...
	/**
	 * Release raw PCM data (the `data` UInt8Array) after the audio
	 * has been uploaded to an OpenAL buffer or similar backend.
	 *
	 * On mobile, audio memory is significant — a 3-minute song at
	 * 44100 Hz stereo 16-bit = ~31 MB. Call this after AL buffer
	 * creation to reclaim that memory.
	 */
